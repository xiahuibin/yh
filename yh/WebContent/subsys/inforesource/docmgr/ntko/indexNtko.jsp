...
var docPriv = "<%=docPriv %>";
  ...
  function doInit(){
   ...
   delFlag = false;
   var url = contextPath + "/yh/subsys/inforesouce/docmgr/act/YHDocAct/getBookmark.act";
...
function getRunData(){
  var url = contextPath + "/yh/subsys/inforesouce/docmgr/act/YHDocAct/getRunData.act";
  var json = getJsonRs(url , "runId=" + runId);
  if (json.rtState == "0") {
...
<param name="ProductKey" value="<%=StaticData.ProductCaption%>">
