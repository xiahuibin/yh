...
<%@ page  import="yh.subsys.inforesouce.docmgr.data.YHDocConst"%>
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/yh/core/styles/style3/img/notify_new.gif"/><span class="big3">新建收文</span>
    </td>
  </tr>
</table>
<form action="<%=contextPath%>/yh/subsys/inforesouce/docmgr/act/YHDocReceiveAct/addYHDocReceive.act" id="form1" method="post" name="form1" >
<table class="TableBlock" width="70%" align="center">
  ...
  <!--  <tr>
	...
	<tr>
    <td nowrap class="TableContent" width="120">承办处室:<br/>(或牵头承办处室)&nbsp;</td>
    <td nowrap class="TableData">
  ...
  <!--<tr>
   ...
   <tr>
    <td nowrap  class="TableControl" colspan="2" align="center">
        <input type="button" id="save" name="save" value="保存" class="BigButton"  name="button" onclick="doSubmit('1');"/>&nbsp;
   </td>
   </tr>
