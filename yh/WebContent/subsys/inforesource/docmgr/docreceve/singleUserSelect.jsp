...
String deptIdSel = request.getParameter("dept");
if(deptIdSel == null || deptIdSel == ""){
  deptIdSel = "-1";
}
%>
...
<script type="text/javascript" src="js/MultiUserSelect.js"></script>
...
<div style="position:absolute;top:330px;left:105px;height:30px;width:60px;">
