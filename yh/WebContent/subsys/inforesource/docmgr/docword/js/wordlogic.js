 ...
 */
function exportWord(){
  location = contextPath + "/yh/subsys/inforesouce/docmgr/act/YHSubjectTermAct/exportToExcel.act";
}
/**
 * 导入主题词
 * 
...
function importWord(){
  ...
  parent.location = contextPath + "/subsys/inforesource/docmgr/docword/importword.jsp?flag="+flag;
}
