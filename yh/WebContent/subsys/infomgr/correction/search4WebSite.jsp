...
.table_header{
  ...
  height:33px;
  width:874px;
  background: url(<%=imgPath%>/subsys/c_table_header.jpg)  no-repeat left top;
}
...
.header_logo{
  height:47px;
  width:196px;
  background: url(<%=imgPath%>/subsys/c_header_logo.jpg)  no-repeat left top;
}
...
function doInit(){
  ...
  var requestURL = "<%=contextPath%>/yh/subsys/infomgr/bilingual/act/YHCorrectionAct/getPage4WebSite.act";
  var cfgs = {
    dataAction: requestURL,
    container: "listDiv",
    colums: [
			{type:"hidden", name:"seqId", text:"ID"},
			{type:"text", name:"content", text:"标示错误内容", width:220,align:'center'},
			{type:"text", name:"picture", text:"标示错误图片", width:215,align:'center',render:pictureRender},
			{type:"text", name:"address", text:"标示牌具体位置", width:218,align:'center'},
			{type:"text", name:"changes", text:"更改结果", width:211,align:'center'}
		]
  };
  ...
  <center>
    <div style="text-align:left;width:906px; border: 1px solid rgb(255, 45, 45)">
      ...
      <div style="margin:0px 16px;">  
        ...
        <div id="listDiv" align="center" style="margin:0px 1px;width:874px;"></div>
      </div>
