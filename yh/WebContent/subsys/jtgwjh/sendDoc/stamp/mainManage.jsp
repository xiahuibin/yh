...
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/jtgwjh/docSend/act/YHDocSendStampAct/getListJson.act";
  var cfgs = {
    dataAction: url,
    ...
    colums: [
       ...
       {type:"hidden", name:"statue",  width: '10%', text:"盖章详情" ,align: 'center' ,render: renderStampStatue},
...
function opts(cellData, recordIndex, columIndex){
  ...
  return "<center>"
        + "<a href=javascript:toStamp(" + seqId + ",1)>盖章</a>&nbsp;"
        + "</center>";
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/notify_open.gif" align="absMiddle"><span class="big3">&nbsp;主办待盖章列表 </span>
   </td>
 </tr>
</table>
<br>
