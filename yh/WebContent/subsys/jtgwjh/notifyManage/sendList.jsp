...
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/jtgwjh/notifyManage/act/YHJhNotifyInfoAct/getListJson.act?publish=1";
  var cfgs = {
    dataAction: url,
    ...
    colums: [
       ...
       {type:"data", name:"publish",  width: '10%', text:"状态" ,align: 'center',render:changePublish },
