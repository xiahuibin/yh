...
function doInit() {
    ...
    if(rtJson.rtState == "0"){
      ...
      bindJson2Cntrl(data);
      $("reciveDept").value = data.receiveDept;
      $("reciveDeptDesc").value = data.receiveDeptName;	
      ...
      if(data.attachmentId){
          ...
          attachMenuSelfUtil("showAtt","notify",$('attachmentName').value ,$('attachmentId').value, '','','<%=seqId%>',selfdefMenu);
        }else{
...
function doSubmit(){
	...
	if(checkForm()){
	    ...
	    $('notifyTitleConfirm').innerHTML = $('title').value;
...
//确认页面发送事件
function doSubmit3(){
  $("form1").action = "<%=contextPath%>/yh/subsys/jtgwjh/notifyManage/act/YHJhNotifyInfoAct/addNotifyInfo.act?sendFlag=1";
  $("form1").submit();
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath %>/notify_new.gif" align="middle"><span class="big3" id="titleSpan"> 修改公告</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/yh/subsys/jtgwjh/notifyManage/act/YHJhNotifyInfoAct/updateNotifyInfo.act?seqId=<%=seqId%>"  method="post" name="form1" id="form1" onsubmit="">
	<table class="TableBlock" width="80%" align="center">
	  <tr>
      <td nowrap class="TableData">公告标题：<font color="red">*</font> </td>
      <td class="TableData"colspan="5">
        <input type="text" name="title" id="title" class="BigInput" size="80">
...
<!--     <tr>
     ...
     <tr>
      ...
      <td class="TableData" id="showAttachment">
        ...
        <input type="hidden" id="moduel" name="moduel" value="jtgwjh">
        <span id="showAtt">
        </span>
      </td>
    </tr>
    ...
    <tr align="center" class="TableControl">
      <td colspan='6' nowrap>
        ...
        <input type="button" value="返回" onclick="window.location.href='<%=contextPath %>/subsys/jtgwjh/notifyManage/draftList.jsp';" class="BigButton">
  ...
  <table class="TableBlock" width="60%" align="center">
    ...
    <tr align="center" class="TableControl">
      <td colspan='6' nowrap>
        ...
        <input type="button" value="修改" onclick="doSubmit2();" class="BigButton">
