...
function doSubmit(){
	if(checkForm()){
	  ...
	  var url = "<%=contextPath%>/yh/subsys/jtgwjh/search/act/YHDocSearchAct/getReciveListJson.act?";
	  var cfgs = {
	    dataAction: url,
	    ...
	    colums: [
	       ...
	       {type:"data", name:"docTitle",  width: '15%', text:"文件标题" ,align: 'left' ,render: toDocTitle},
	       ...
	       {type:"hidden", name:"sendDept",  width: '10%', text:"联网接收单位" ,align: 'center' },
	       {type:"data", name:"sendDeptDesc",  width: '15%', text:"联网发送单位" ,align: 'center' ,render: renderReciveDeptDesc},
	       {type:"hidden", name:"sendDatetime",  width: '10%', text:"创建时间" ,align: 'center' ,render: renderCreateDatetime},
	       {type:"data", name:"status",  width: '10%', text:"状态" ,align: 'center' ,render: renderStatus},
	       {type:"data", name:"status",  width: '10%', text:"办理状态" ,align: 'center' ,render: renderHandStatus},
	       {type:"hidden", name:"receiveDatetime",  width: '10%', text:"发送时间" ,align: 'center' }]
	  };
...
function renderHandStatus(cellData, recordIndex, columIndex){
  var str = "";
  if(cellData == 1){
    str = '已归档';
  }else if(cellData == 2){
...
<table border="0" width="80%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/infofind.gif"><span class="big3"> 收文统计查询</span></td>
  </tr>
</table>
<br>
...
<table class="TableBlock" align="center" >
  ...
  <tr>
    ...
    <td nowrap class="TableContent">办理情况： </td>
    <td class="TableData">
      <select id="handStatus" name="handStatus" style="width:71px;">
        <option value=''></option>
  ...
  <tr>
    ...
    <td class="TableData" colspan="5">
      ...
      <textarea id="sendDeptDesc" name="sendDeptDesc" rows="3" style="width:80%" class="BigStatic" readonly></textarea>
      <a href="javascript:void(0);" class="orgAdd" onClick="selectOutDept(['sendDept', 'sendDeptDesc']);">添加</a>
      <a href="javascript:void(0);" class="orgClear" onClick="$('sendDept').value='';$('sendDeptDesc').value='';">清空</a>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td nowrap class="TableContent">接收日期： </td>
...
<table border="0" width="80%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/infofind.gif"><span class="big3"> 收文统计查询结果 </span></td>
 </tr>
</table>
<br>
