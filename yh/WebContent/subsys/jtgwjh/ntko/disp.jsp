...
createDisp();
 ...
 <OBJECT id=HWPostil1 style="WIDTH:800px;HEIGHT:600px" classid=clsid:FF3FE7A0-0578-4FEE-A54E-FB21B277D567 codeBase='<%=contextPath %>/subsys/jtgwjh/setting/aip/HWPostil.cab#version=3.0.9.4' >"
 </OBJECT>
</body>
</html>