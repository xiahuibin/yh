...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/subsys/oa/abroad/act/YHHrAbroadRecordAct/getRecordInfoDetail.act?seqId=${param.seqId}";
  ...
  if(rtJson.rtState == "0"){
    ...
    if($("abroadUserId") && $("abroadUserId").value.trim()){
      bindDesc([{cntrlId:"abroadUserId", dsDef:"PERSON,SEQ_ID,USER_NAME"}]);
    }
  }else{
    alert(rtJson.rtMsrg); 
  }
...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/yh/subsys/oa/abroad/act/YHHrAbroadRecordAct/updateRecord.act";
...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td><img src="<%=imgPath%>/notify_new.gif" align="absmiddle"><span class="big3"> 编辑出国记录</span>&nbsp;&nbsp;
    </td>
  </tr>
</table>
<br>
 ...
 <tr>
    ...
    <tr align="center" class="TableControl">
      ...
      <input type="hidden" name="seqId" id="seqId" value=""> 
        ...
        <input type="button" value="返回" class="BigButton" onclick="javascript:location.href = '<%=contextPath %>/subsys/oa/abroad/record/manage.jsp'">
      </td>
    </tr>
  </table>
</body>
