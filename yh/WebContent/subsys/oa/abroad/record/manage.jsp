...
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/oa/abroad/act/YHHrAbroadRecordAct/getAbroadRecordListJson.act";
  var cfgs = {
      dataAction: url,
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/infofind.gif" align="absMiddle"><span class="big3">&nbsp;出国记录信息</span>
   </td>
 </tr>
</table>
<br>
