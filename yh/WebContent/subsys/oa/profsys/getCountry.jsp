...
function doInit(){
  ...
  url = contextPath + "/yh/subsys/oa/profsys/act/YHProjectAct/getCountry.act?&privOp=" + privOp;
  if (moduleId) {
...
<div id="rightRole">
<div id="hasRole">
<div id="title" class="header" >选择国家<input type=button class="SmallButtonW" value="确定" onclick="window.close()"/></div>
...
<div id="noRole" align="center"  class=item style="display:none;color:red">未定义</div>
<div style="position:absolute;top:330px;left:180px;height:30px;width:60px;">
