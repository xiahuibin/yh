    ...
    var htmlTableHead = '<input type="hidden" id="len" name="len" value="'+len+'">'+
                       '<table width="70%" align="center" class="TableBlock">'+
                          ...
                          '<tr>'+
                            ...
                            '<td nowrap class="TableData" width="25px">归还数量：</td>'+
                            '<td nowrap class="TableData">处理：</td>'+
                            '<td nowrap class="TableData">实际数量：</td>'+
                          '</tr>';
    var htmlTableFoot = '<tfoot align="center" class="TableFooter">'+
                            '<td colspan="7" nowrap>'+
...
<table border="0" width="50%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/notify_new.gif" align="middle"><span class="big3">&nbsp;处理待批归还</span>
    </td>
  </tr>
</table>
<br>
...
<table class="MessageBox" align="center" width="320">
  <tr>
    <td class="msg info">
      ...
      <div class="content" style="font-size:12pt">待批归还处理成功！</div>
    </td>
  </tr>
</table>
<br><center>
