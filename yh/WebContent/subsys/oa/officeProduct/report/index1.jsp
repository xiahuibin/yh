...
<frameset rows="200,*"  frameborder="NO" border="0" framespacing="0" id="frame1">
    <frame name="select" id="select" scrolling="auto" src="select.jsp?module=<%=module%>"  frameborder="no">
    <frame name="tumain" id="tumain" scrolling="auto" src="analysis.jsp?module=<%=module%>&mapType=<%=mapType%>" frameborder="no">
</frameset>