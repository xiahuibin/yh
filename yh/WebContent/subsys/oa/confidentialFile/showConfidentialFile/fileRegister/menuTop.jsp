...
<div id="navPanel">
  <div id="navMenu">
    <a href="left.jsp?seqId=0" target="file_tree" title="机要文件" hidefocus="hidefocus"><span><img src="<%=imgPath %>/file_folder.gif" width="16" height="16" align="middle" />&nbsp;机要文件</span></a>
  </div>
