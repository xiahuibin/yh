...
function sendForm(){
	if(checkForm()){
		...
		location = "<%=contextPath%>/subsys/oa/confidentialFile/showConfidentialFile/fileRegister/globalSearch.jsp?"+query
	}
}
function checkDate(){
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/folder_search.gif" align="middle"><b>&nbsp;<span class="Big1" id="folderName">全局搜索</span></b><br>
    </td>
  </tr>
</table>
