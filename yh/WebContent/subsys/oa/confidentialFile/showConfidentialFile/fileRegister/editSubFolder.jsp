...
var requestURL = "<%=contextPath%>/yh/subsys/oa/confidentialFile/act/YHShowConfidentialSortAct";
var seqId='<%=seqId%>';	
function doInit(){
	document.form1.sortName.focus();
	var url = requestURL + "/getFileSortInfoById.act";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/edit.gif" WIDTH="22" HEIGHT="20" align="middle"><span class="big3"> 编辑子文件夹</span>
    </td>
  </tr>
</table>
<br>
