...
function sendForm(){
	if(checkForm()){
		...
		location = "<%=contextPath %>/subsys/oa/confidentialFile/showConfidentialFile/fileRegister/search.jsp?"+query
	}
}
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/folder_search.gif" align="middle"><b>&nbsp;<span class="Big1" id="folderName"> </span>- 查询文件</b><br>
    </td>
  </tr>
</table>
<br>
