...
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/oa/confidentialFile/act/YHConfidentialContentAct/getFileNotSendListJson.act?fileSend=1";
  var cfgs = {
      dataAction: url,
...
<table id="headTableStr" border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/notify_open.gif" align="middle"><b>&nbsp;<span class="big3" >已报送文件 </span></b>&nbsp;
   </td>
  </tr>
</table>
<br>
