...
function doInit(){
	...
	var url=requestURL + "/getFileSortList.act";
...
function set_priv(seqId){
	var url="setPriv/index.jsp?seqId="+seqId;
	location.href=url;
}

function show_priv(seqId){
	var url="showPriv/index.jsp?seqId="+seqId;
	location.href=url;
}
...
function delete_Proces(seqId){
 	var msg='确认要删除该文件夹吗？这将删除该文件夹中的所有文件且不可恢复！';
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/notify_new.gif" WIDTH="22" HEIGHT="20" align="middle"><span class="big3"> 新建文件夹</span><br>
    </td>
  </tr>
</table>
<div align="center">
<input type="button"  value="新建文件夹" class="BigButton" onClick="location='new/newConfidentialSort.jsp';" title="创建新的文件夹">
</div>
<br>
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/notify_open.gif" align="middle"><span class="big3"> 管理文件夹</span>
    </td>
  </tr>
</table>
...
<div id="ModalDialog" class="ModalDialog" style="width:300px;">
  ...
  <div id="body" class="body">
    <form name="form1" id="form1" action="">
      ...
      <div style="padding-top:3px">新文件夹名：<font color="red">*</font>&nbsp;<input type="text" id="sortName" name="sortName" class="SmallInput" size="20" /></div>     
   </form>
  </div>
