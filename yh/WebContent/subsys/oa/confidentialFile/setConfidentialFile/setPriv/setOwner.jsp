...
function sendForm(){
  ...
  var ownerId=dept+"|"+role+"|"+user;
  //alert('seqId:'+seqId+">>>>>ownerId:"+ownerId);
	var override=checkOverride();
  var url = requestURL + "/setOwnerById.act?ownerId=" + ownerId + "&seqId=" + seqId + "&override=" + override;
...
指定该文件夹的所有者，所有者可以设置该文件夹和子文件夹的访问、管理、新建和下载权限    </td>
  </tr>
</table>
