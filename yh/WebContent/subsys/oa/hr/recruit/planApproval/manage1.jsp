...
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/oa/hr/recruit/plan/act/YHHrRecruitPlanAct/getRecruitPlanWaitListJson.act?planStatus=0";
  var cfgs = {
    dataAction: url,
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/notify_open.gif" align="absMiddle"><span class="big3">&nbsp;待审批计划 </span>
   </td>
 </tr>
</table>
<br>
