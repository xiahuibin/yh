...
function doInit(){
  if(checkForm()){
    ...
    var url = "<%=contextPath %>/yh/subsys/oa/hr/setting/act/YHHrCodeAct/addChildCode.act";
...
function doOnload(){
  ...
  for(var i = 0;i<prcs.length ; i++){
    ...
    var codeName = prc.codeName;
    var myOption = document.createElement("option");
    myOption.value = seqId;
    myOption.text = codeName;
...
<form name="form1" id="form1" method="post">
    ...
    <h2><img src="<%=contextPath %>/core/styles/imgs/green_plus.gif"></img>添加代码项</h2> 
