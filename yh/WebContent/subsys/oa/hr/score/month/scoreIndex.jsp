...
<frameset rows="*"  cols="180,*" frameborder="NO" border="0" framespacing="0" id="frame1">
    ...
    <frame name="hrms" id="hrms" scrolling="auto" src="scoreList.jsp?flowId=<%=flowId %>&userId=<%=userId %>&currPage=1&checkFlag=<%=checkFlag %>&groupId=<%=groupId %>&year=<%=year%>&month=<%=month%>" frameborder="no">
</frameset>