...
<frameset rows="*"  cols="180,*" frameborder="NO" border="0" framespacing="0" id="frame1">
    <frame name="file_tree" id="file_tree" scrolling="auto" src="user.jsp?flowId=<%=flowId %>&userId=<%=userId %>&groupId=<%=groupId %>&groupFlag=<%=groupFlag %>&checkFlag=<%=checkFlag %> "  frameborder="no">
    <frame name="hrms" id="hrms" scrolling="auto" src="blank.jsp?flowId=<%=flowId %>&groupFlag=<%=groupFlag %>&checkFlag=<%=checkFlag %>&currPage=1" frameborder="no">
</frameset>