...
function doInit(){
  var seqId = ${param.flowId};
  var flowTitle = getFlowTitleName(seqId);
...
<table class="MessageBox" align="center" width="300">
  <tr>
    <td class="msg info">
      <div class="content" style="font-size:12pt"><span id="flowTitleSpan"></span></div>
    </td>
  </tr>
</table>

<br><center><input type="button" class="BigButton" value="返回" onclick="parent.location.href='<%=contextPath %>/subsys/oa/hr/score/submit/index.jsp';"></center></body>
</html>