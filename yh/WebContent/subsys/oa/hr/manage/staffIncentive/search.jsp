...
<%
  ...
  String incentiveTime1 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("incentiveTime1")));
  String incentiveTime2 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("incentiveTime2")));
  String incentiveItem = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("incentiveItem")));
  String incentiveType = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("incentiveType")));
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/infofind.gif" align="absMiddle"><span class="big3">&nbsp;奖惩信息查询结果 </span>
   </td>
 </tr>
</table>
<br>
...
<br>
  <input type="button" value="返回" class="BigButton" onclick="window.location.href='<%=contextPath %>/subsys/oa/hr/manage/staffIncentive/query.jsp';">&nbsp;&nbsp;
</div>
