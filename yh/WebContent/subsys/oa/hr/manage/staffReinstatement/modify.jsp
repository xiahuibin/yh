...
function deleteAttachBackHand(attachName,attachId,attrchIndex) { 
  var url = "<%=contextPath%>/yh/subsys/oa/hr/manage/reinstatement/act/YHHrStaffReinstatementAct/delFloatFile.act?delAttachId=" + attachId + "&seqId=<%=seqId%>";
...
<br>
<form enctype="multipart/form-data" action="<%=contextPath%>/yh/subsys/oa/hr/manage/reinstatement/act/YHHrStaffReinstatementAct/updateReinstatementInfo.act"  method="post" name="form1" id="form1" onsubmit="">
