...
<%
  String reinstatementPerson = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("reinstatementPerson")));
  String reappointmentType = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("reappointmentType")));
  String applicationDate1 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("applicationDate1")));
  String applicationDate2 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("applicationDate2")));
  String reappointmentTimeFact1 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("reappointmentTimeFact1")));
  String reappointmentTimeFact2 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("reappointmentTimeFact2")));
  String reappointmentState = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("reappointmentState")));
  String materialsCondition = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("materialsCondition")));
%>
...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/subsys/oa/hr/manage/reinstatement/act/YHHrStaffReinstatementAct/queryReinstatementListJson.act?" + param;
  var cfgs = {
    dataAction: url,
