...
<%
  String leavePerson = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("leavePerson")));
  String quitType = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("quitType")));
  String quitTimePlan1 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("quitTimePlan1")));
  String quitTimePlan2 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("quitTimePlan2")));
  String quitTimeFact1 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("quitTimeFact1")));
  String quitTimeFact2 = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("quitTimeFact2")));
  String quitReason = YHUtility.encodeSpecial(YHUtility.null2Empty(request.getParameter("quitReason")));
...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/subsys/oa/hr/manage/leave/act/YHHrStaffLeaveAct/queryLeaveListJson.act?" + param;
  var cfgs = {
    dataAction: url,
