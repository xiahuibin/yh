...
function doInit(){
	var url = "<%=contextPath%>/yh/subsys/oa/hr/manage/staffInfo/act/YHHrStaffInfoQueryAct/getRetireeListJson.act";
	var cfgs = {
	    dataAction: url,
	    ...
	    colums: [
	       ...
	       {type:"hidden", name:"userId",  text:"personId", dataType:"int"},
	       {type:"selfdef", text:"操作", width: '20',render:retireeResultOpts}]
	  };
