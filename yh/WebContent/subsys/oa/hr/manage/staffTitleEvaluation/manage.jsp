...
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/oa/hr/manage/titleEvaluation/act/YHHrStaffTitleEvaluationAct/getStaffTitleEvaluationListJson.act";
  var cfgs = {
    dataAction: url,
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/notify_open.gif" align="absMiddle"><span class="big3">&nbsp;管理职称评定 </span>
   </td>
 </tr>
</table>
<br>
