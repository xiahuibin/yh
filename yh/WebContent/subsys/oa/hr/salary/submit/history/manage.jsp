...
<script type="text/javascript" src="<%=contextPath %>/subsys/oa/hr/salary/submit/history/js/util.js"></script>
<script type="text/javascript" src="<%=contextPath%>/subsys/oa/hr/salary/submit/history/js/submitLogic.js"></script>
<script> 
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/oa/hr/salary/submit/act/YHHrSubmitAct/getSubmitHistoryListJson.act";
  var cfgs = {
    dataAction: url,
