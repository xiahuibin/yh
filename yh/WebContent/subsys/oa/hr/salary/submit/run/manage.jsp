...
<script type="text/javascript" src="<%=contextPath %>/subsys/oa/hr/salary/submit/run/js/util.js"></script>
<script type="text/javascript" src="<%=contextPath%>/subsys/oa/hr/salary/submit/run/js/submitLogic.js"></script>
<script> 
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/oa/hr/salary/submit/act/YHHrSubmitAct/getSubmitListJson.act";
  var cfgs = {
    dataAction: url,
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/notify_open.gif" align="absMiddle"><span class="big3">&nbsp;（财务工资录入）待办流程 </span>
   </td>
 </tr>
</table>
<br>
