...
function doInit(){
  ...
  var cfgs = {
      ...
      colums: [
         ...
         {type:"data", name:"incentiveItem",  width: '20%', text:"奖励项目", render:incentiveItemFunc},
         {type:"data", name:"incentiveTime",  width: '10%', text:"奖励日期", render:splitDateFunc},
         {type:"data", name:"incentiveType",  width: '10%', text:"奖励属性", render:incentiveTypeFunc},
         {type:"data", name:"incentiveAmount",  width: '10%', text:"奖励金额", render:incentiveAmountFunc},
...
function opts1(cellData, recordIndex, columIndex){
	...
	return "<center>"
				+ "<a href=javascript:staffAwardDetail(" + seqId + ")>详细信息</a>&nbsp;"
				+ "</center>";
}

function staffAwardDetail(seqId){
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/infofind.gif" align="absMiddle"><span class="big3">&nbsp;奖励信息查询结果 </span>
   </td>
 </tr>
</table>
<br>
