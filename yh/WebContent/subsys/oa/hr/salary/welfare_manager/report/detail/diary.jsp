...
function doInit() {
  ...
  var url =  contextPath + "/yh/subsys/oa/hr/salary/report/act/YHHrReportAct/searchDiarySelf.act?" + param;
  var cfgs = {
    dataAction: url,         
...
function subjectRender(cellData, recordIndex, columIndex) {
  //alert(cellData);
  var diaId = this.getCellData(recordIndex,"seqId");
  return "<A  id=\"sub_" + recordIndex + "_" + columIndex + "\" href=\"" + contextPath + "/subsys/oa/hr/salary/report/detail/diary_read.jsp?diaId=" + diaId + "\">" + cellData + "</A >";
}
/**
 * 
 */
