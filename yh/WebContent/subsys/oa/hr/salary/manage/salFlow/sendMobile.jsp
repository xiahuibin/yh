...
function exreport(event) {
  ...
  var urlStr = "<%=contextPath%>/yh/subsys/oa/hr/salary/salFlow/act/YHHrSalFlowAct";
  var url = urlStr + "/sendMobile.act";
  var rtJson = getJsonRs(url, "flowId=<%=flowId%>&content="+content+"&userIdStr="+userIdStr+"&fldStr="+fldStr );
  if (rtJson.rtState == "0") {
	  var data = rtJson.rtData;
	  $('userNameTo').value = data;
	  $('form2').action = "<%=contextPath%>/subsys/oa/hr/salary/manage/salFlow/newRemind2.jsp";
	  $('form2').submit();
  } else {
    alert(rtJson.rtMsrg);
  }
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/mobile_sms.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">&nbsp;手机工资条  </span>
   </td>
  </tr>
</table>
<div align="center">
