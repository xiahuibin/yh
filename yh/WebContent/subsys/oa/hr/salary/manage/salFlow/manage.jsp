...
<script type="text/javascript" src="<%=contextPath %>/subsys/oa/hr/salary/manage/salFlow/js/util.js"></script>
<script type="text/javascript" src="<%=contextPath%>/subsys/oa/hr/salary/manage/salFlow/js/salFlowLogic.js"></script>
<script> 
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/oa/hr/salary/salFlow/act/YHHrSalFlowAct/getSalFlowListJson.act";
  var cfgs = {
    dataAction: url,
    ...
    colums: [
       ...
       {type:"data", name:"sendTime",  width: '10%', text:"流程创建时间" ,align: 'center' ,render:splitDateTimeFunc},
       ...
       {type:"data", name:"issend",  width: '10%', text:"状态" ,align: 'center' ,render:issendFunc},
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/notify_open.gif" align="absMiddle"><span class="big3">&nbsp;已定义的工资流程 </span>
   </td>
 </tr>
</table>
<br>
