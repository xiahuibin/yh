...
<script type="text/javascript" src="<%=contextPath %>/subsys/oa/hr/salary/report/history/js/util.js"></script>
<script type="text/javascript" src="<%=contextPath%>/subsys/oa/hr/salary/report/history/js/reportLogic.js"></script>
<script> 
var pageMgr = null;
function doInit(){
  var url = "<%=contextPath%>/yh/subsys/oa/hr/salary/report/act/YHHrReportAct/getReportHistoryListJson.act";
  var cfgs = {
    dataAction: url,
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
 <tr>
   <td class="Big"><img src="<%=imgPath%>/notify_open.gif" align="absMiddle"><span class="big3">&nbsp;历史流程</span>
   </td>
 </tr>
</table>
<br>
