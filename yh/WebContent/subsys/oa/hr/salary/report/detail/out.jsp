...
function doOnload(){
  var requestURL = "<%=contextPath%>/yh/subsys/oa/hr/salary/report/act/YHHrReportAct/selectHistoryOut.act";
  ...
  if(prcsJson.length>0){
    ...
    for(var i =0;i< prcsJson.length;i++){
      ...
      tr.update("<td nowrap align='center'>" + createDate + "</td>"
          ...
          + "<td nowrap align='center'>" + submitTime.substr(0,11) + outTime1+ "</td>"
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/views/attendance.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">  &nbsp;外出记录</span><br>
    </td>
  </tr>
</table>
