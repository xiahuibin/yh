...
function doSubmit(){
  ...
  var url = "<%=contextPath %>/yh/subsys/oa/rollmanage/act/YHRmsRollAct/addRoll.act";
  var json = getJsonRs(url,pars);
  if(json.rtState == "0"){
    window.location.href = "<%=contextPath %>/subsys/oa/rollmanage/add.jsp";
  }else{
    alert("修改失败");
  }
...
<table border="0" width="90%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/notify_new.gif" align="absmiddle"><span class="big3"> 新建案卷</span>
    </td>
  </tr>
</table>
  ...
  <TR>
      ...
      <td nowrap class="TableData">设置档案分类优先级：<font style='color:red'>*</font>
      </td>
      <td class="TableData">
