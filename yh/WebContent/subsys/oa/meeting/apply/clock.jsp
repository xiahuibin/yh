...
window.onload=function (){
   ...
   timeField = parent_window.$(parent_window.timeField);//初始化对象
...
<div class="big1" align="center">
	<b>时间：<select name=hour id=hour class=BigSelect style="width:50px">	</select>	：<select name=minite id=minite class=BigSelect style="width:50px">	</select>	：<select name=second id=second class=BigSelect style="width:50px">	</select>
	<br>
	<br>
