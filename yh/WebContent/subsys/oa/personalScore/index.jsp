...
function getMonthScore(){
  ...
  if(rtJson.rtState == "0"){
   ...
   return insertKiloSplit(data.monthScore,2);
  }else{
    alert(rtJson.rtMsrg); 
  }
}
...
function doInit2(){
  ...
  if(rtJson.rtState == "0"){
    ...
    .update("<tbody id='tbody'><tr class='TableHeader'>"
      + "<td nowrap width='10%' align='center'>考核月份</td>"
      + "<td nowrap width='10%' align='center'>处长主观分</td>"
      + "<td nowrap width='10%' align='center'>考勤分</td>"
      + "<td nowrap width='10%' align='center'>奖惩分</td>"
      + "<td nowrap width='10%' align='center'>月考核分</td></tr><tbody>");
     ...
     var tr=new Element('tr',{'class':trColor});   
      ...
      if(month < i){
        ...
        if(day > 25){
          ...
          str = "<td align='center'>" + i + "月</td><td align='center'>"
          +getAttendScore(strs)+"</td><td align='center'>"
          +getAttendScore(strs)+"</td><td align='center'>"
          +getAttendScore(strs)+"</td><td align='center'>"
          +getScore(strs)+"</td>";
        }
