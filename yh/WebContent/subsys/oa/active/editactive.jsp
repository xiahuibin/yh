...
function doOnload(){
  ...
  if(prc.seqId){
    ...
    var hour = activeTime.substr(11,2);
    var min = activeTime.substr(14,2);
    $("activeTime").value = date;
    $("hour").value  = hour;
    $("min").value = min;
    $("activeContent").value=activeContent;
    $("activeUser").value = activeUser;
    $("activeUserDesc").value = activeUserName;
  }
...
function doInit(){
  if(CheckForm()){
    var requestUrl = "<%=contextPath%>/yh/subsys/oa/active/act/YHActiveAct/updateActive.act";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/untitled.bmp" align="absMiddle" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">&nbsp;编辑活动安排</span>
    </td>
  </tr>
</table>
