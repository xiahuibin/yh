...
function loadData(pageIndex,pageSize){
  var param = "pageIndex=" + pageIndex + "&ruleName=bgzl-zxtz" + "&filter_typeId=1&filter_publish=0";
  ...
  if(rtJson.rtState == "0"){
    ...
    for(var i = 0 ; i < data.pageData.length; i++){
      ...
      var hrefUrl = "modules/bgzl/bgzl-yzqk.jsp?Id=" + newId;
...
<div class="s-left">
  <div class="s-menu">
	  ...
	  <div class="menu-button1"><a href="modules/bgzl/bgzl-yzqk-list.jsp" target="mainframe">一周情况</a></div>
	  <div class="menu-button1"><a href="modules/bgzl/bgzl-gwg-list.jsp" target="mainframe">公文库</a></div>
   </div>
   ...
   <!--第一块从这里开始-->
     <div class="box-two-a">
	   ...
	   <span class="popular-title">中心通知</span>
	   </div>
