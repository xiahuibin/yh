...
function loadData(pageIndex,pageSize){
  var param = "pageIndex=" + pageIndex +"&pageSize=" + pageSize+ "&ruleName=deptActive" + "&filter_dept=ALL_DEPT";
  ...
  if(rtJson.rtState == "0"){
    ...
    for(var i = 0 ; i < data.pageData.length; i++){
      ...
      var hrefUrl = "zxjj-d-content.jsp?Id=" + newId;
...
<div class="s-left">
   ...
   <!--第一块从这里开始-->
     <div class="box-two-a">
	   <div class="two-a-up"><img src="images-other/work-header-tit.jpg" width="131" height="42" border="0"/></div>
