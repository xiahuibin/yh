...
function doInit(){
  if(type == 1){
    $('title').innerHTML = "专题调研";
   }else if(type == 2){
     $('title').innerHTML = "调研报告";
   }else if(type == 3){
     $('title').innerHTML = "调研专刊";
   }else if(type == 4){
     $('title').innerHTML = "会议资料库";
   }else if(type == 5){
     $('title').innerHTML = "择要";
   }
...
function loadData(pageIndex,pageSize){
  ...
  var url =  contextPath + "/yh/subsys/portal/guoyan/module/act/YHPortalGridModuleRes/loadDataPage.act";
...
<div class="frame-box-three">
     <div class="box-three-page">
	   ...
	   <span class="page-aweektxt" id="title"></span>
	   </div>
