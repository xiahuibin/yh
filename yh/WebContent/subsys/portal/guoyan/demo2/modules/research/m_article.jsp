...
function doInit(){
  ...
  var param = "Id=" + newsId + "&ruleName=research_m";
  ...
  parent.autoHeight2("xsqkData");
  parent.autoHeight2("xsqkMenu");
  if(parent.getParentFrame){
  parent.getParentFrame(parent.$("xsqkData").height);
  }
}
</script>
</head>
...
<div class="frame-box-two">
   <!--第一块从这里开始-->
     <div class="article">
	   <div class="two-a-up">
	   <img src="../../images-other/icon_short.jpg" width="60" height="39" border="0"/></div>
