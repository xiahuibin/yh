...
function doInit(){
  ...
  var param = "Id=" + newsId + "&ruleName=deptNotify";
  ...
  parent.autoHeight2("deptData");
  parent.getParentFrame(parent.$("deptData").height);
  //alert(parent.$("deptData").height + parent.getParentFrame().id);
  //parent.getParentFrame().style.height = $("deptData").style.height ;
  //alert(3)
}
</script>
</head>
