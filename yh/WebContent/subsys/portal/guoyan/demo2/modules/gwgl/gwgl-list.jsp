...
function loadData(pageIndex,pageSize){
  var param = "pageIndex=" + pageIndex +"&pageSize=" + pageSize+ "&ruleName=door_gwgl";
...
<div class="s-left">
   ...
   <!--第一块从这里开始-->
     <div class="box-two-a">
	   ...
	   <span class="popular-title">公文管理</span>
	   </div>
