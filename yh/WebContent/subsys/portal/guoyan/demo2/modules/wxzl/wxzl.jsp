...
function doInit(){
  ...
  var param = "Id=" + newsId + "&ruleName=wxzl";
  var rtJson = getJsonRs(url,param);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
    $('subject').innerHTML = data.bookName;
    $('content').innerHTML = data.content;
    $('publish').innerHTML = "发布人：" + data.borrPerson;
    $('newsTime').innerHTML = "发布日期：" + data.pub_date.substring(0,10);
  }
}
</script>
</head>
