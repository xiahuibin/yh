...
function doInit(){
	if(typeId == 1){
		$("title").innerHTML = "科学发展观学习专栏";
	}
	else if(typeId == 2){
		$("title").innerHTML = "十七大学习专栏";
	}
	else{
		$("title").innerHTML = "先进性教育专栏";
	}
...
function loadData(pageIndex,pageSize){
  var param = "pageIndex=" + pageIndex +"&pageSize=" + pageSize+ "&ruleName=djgz"+ "&filter_typeId=<%=typeId%>";
...
<div class="s-left">
   <div class="s-menu">
      <div class="menutit-bg">党建工作</div>
    <div class="menu-button1"><a href="djgz-list.jsp?typeId=1" target="mainframe">科学发展观学习专栏</a></div>
    <div class="menu-button1"><a href="djgz-list.jsp?typeId=2" target="mainframe">十七大学习专栏</a></div>
    <div class="menu-button1"><a href="djgz-list.jsp?typeId=3" target="mainframe">先进性教育专栏</a></div>
   </div>
