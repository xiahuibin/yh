...
<div class="s-left">
   <div class="s-menu">
	  ...
	  <div class="menu-button1"><a href="dept-a.jsp" target="mainframe">部门通知</a></div>
	  <div class="menu-button1"><a href="dept-a.jsp" target="mainframe">工作动态</a></div>
   </div>
   ...
   <div class="box-two-a">
	  <div class="two-a-up">
	   ...
	   <span class="popular-title">部门职责</span>
	   </div>
	   <div class="two-a-down-popular"> 显示部门职责
	 </div>
	 <div class="h10px"></div>
