...
function doInit(){
  ...
  var param = "Id=" + newsId + "&ruleName=kygl-dybg";
  var rtJson = getJsonRs(url,param);
  if(rtJson.rtState == "0"){
    var data = rtJson.rtData;
    $('subject').innerHTML = data.subject;
    var content = imageHandler(data.content);
    ...
    attachMenuSelfUtil("attr","file_folder",attachmentName,attachmentId, '','','',selfdefMenu);
   ...
   <!--第一块从这里开始-->
     <div class="article">
	   ...
	   <img src="../../images-other/icon.jpg" width="60" height="39" border="0"/></div>
		  ...
		  <div class="two-a-down-article" id="content">
          </div>
          <div id="attr"></div>
