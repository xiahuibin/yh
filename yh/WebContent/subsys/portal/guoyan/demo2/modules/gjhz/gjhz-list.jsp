...
function loadData(pageIndex,pageSize){
  var param = "pageIndex=" + pageIndex +"&pageSize=" + pageSize+ "&ruleName=gjhz";
...
<div class="s-left">
   ...
   <!--第一块从这里开始-->
     <div class="box-two-a">
	   ...
	   <span class="popular-title">国际合作</span>
	   </div>
