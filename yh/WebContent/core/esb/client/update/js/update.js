...
function renderDetail(cellData,recordIndex,columnIndex){
	 var guId = this.getCellData(recordIndex,"guId");
	// var url = contextPath + "/subsys/jtgwjh/setting/taskLog/taskLogInfo.jsp?guid=" + guId;
	 return"<a href=javascript:showDetail('" + guId + "')>详情</a>";
}

function showDetail(guId){
	  var url = contextPath + "/subsys/jtgwjh/setting/taskLog/taskLogInfo.jsp?guid=" + guId + "&type=3";
	  newWindow(url,'820', '500');
	}
