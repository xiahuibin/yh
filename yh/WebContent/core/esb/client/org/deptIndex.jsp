...
function doInit() {
  var jso = [
            {title:"组织机构", useTextContent:true , contentUrl:"<%=contextPath %>/core/esb/client/org/index.jsp", useIframe:true}
             ,{title:"数据同步",  useTextContent:true,contentUrl:"<%=contextPath %>/core/esb/client/org/deptSeal.jsp", useIframe:true}
                   ];
