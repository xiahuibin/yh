...
function doInit(){
  if(num){
    var cloneUser = document.getElementById("cloneUser");
    cloneUser.style.display = "";
  }else{
    if(seqId){
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/edit.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">&nbsp;编辑角色</span>
    </td>
  </tr>
</table>
</div>
<div id="cloneUser" style="display:none">
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/edit.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">&nbsp;角色克隆</span>
    </td>
  </tr>
</table>
</div>
    ...
    <table class="TableList" width="450" align="center">
      ...
      <tr>
        ...
        <td nowrap class="TableData">
          <input type="text" name="privNo" id="privNo" class="BigInput" size="5" maxlength="8" value="">&nbsp;
