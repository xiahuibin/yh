...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/address.gif" align="absmiddle"><span class="big3">&nbsp;联系人详情 －&nbsp;<span id="psnName"></span></span><br>
    </td>
    </tr>
</table>
  ...
  <input type="hidden" id="dtoClass" name="dtoClass" value="yh.core.funcs.address.data.YHAddress"/>
    ...
    <tr>
    	...
    	<td class="TableData" width="40%" rowspan="6" style="background-color:lightcyan;">
    		&nbsp;&nbsp;&nbsp;<u><font style="FONT-SIZE:9pt;" color="darkred"><b><span id="psnName2"></span></b></font></u><br>
