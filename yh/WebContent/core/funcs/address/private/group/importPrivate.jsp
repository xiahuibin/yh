...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <b>请指定用于导入的CSV文件：</b>
  <form name="form1" id="form1" action="<%=contextPath%>/yh/core/funcs/address/act/YHAddressAct/importAddressPrivate.act" method="post" enctype="multipart/form-data">
    <input type="file" id="csvFile" name="csvFile" class="BigInput" size="30">
    <input type="hidden" id="FILE_NAME" name="FILE_NAME">
    <input type="hidden" id="groupId" name="groupId" value="">
    <input type="button" value="导入" class="BigButton" onClick="importAddressPrivate2();">
  </form>
  <br>
  </div>
  </div>
...
<div id="msrg"></div>
  ...
  <div align="center" id="turnDiv">
   <input type="button" value="返回" class="BigButton" onClick="location='<%=contextPath%>/core/funcs/address/private/group/index.jsp?flag=1';" title="返回">
</div>
</body>
</html>