...
function doInit(){
  var url = "<%=contextPath%>/yh/core/funcs/address/act/YHAddressAct/getEditGroup.act?seqId="+seqId;
...
function commit(){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/address/act/YHAddressAct/updateGroup.act?seqId="+seqId+"&groupNameOld="+encodeURIComponent(groupNameOld);
