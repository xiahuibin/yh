...
function commit(){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/address/act/YHAddressAct/addPublicGroup.act";
  ...
  <form action="insert.php" name="form1">
    ...
    <tr>
      <td nowrap class="TableControl" colspan="2" align="center">
          ...
          <input type="button" value="返回" class="BigButton" title="返回" name="button2" OnClick="location='<%=contextPath%>/core/funcs/address/public/group/index.jsp'">
      </td>
    </tr>
    </form>
</table>
