...
function selectGroup(){
  var url = "<%=contextPath%>/yh/core/funcs/address/act/YHAddressAct/getSelectGroup1.act";
...
function commitSearch(){
  ...
  location = "<%=contextPath %>/core/funcs/address/public/address/searchsubmit.jsp?psnName="+encodeURIComponent(psnName)+"&sex="+sex+"&nickName="+encodeURIComponent(nickName)+"&deptName="+encodeURIComponent(deptName)+"&telNoDept="+encodeURIComponent(telNoDept)+"&addDept="+encodeURIComponent(addDept)+"&telNoHome="+encodeURIComponent(telNoHome)+"&addHome="+encodeURIComponent(addHome)+"&notes="+encodeURIComponent(notes)+"&groupId="+groupId+"&beginDate="+beginDate+"&endDate="+endDate+"&mobileNo="+encodeURIComponent(mobileNo);
