...
<div align="center" class="Big1">
  <b>请指定用于导入的xml文件：</b>
  <form name="form1" id="form1" method="post" action="<%=contextPath %>/yh/core/funcs/workflow/act/YHFlowImportAct/importFlow.act" target="iframe" enctype="multipart/form-data" onsubmit="return CheckForm();">
