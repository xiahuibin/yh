...
<script language="JavaScript" src="<%=contextPath %>/core/funcs/workflow/flowdesign/flowdesigner2.js"></script>
<script language="JavaScript" src="<%=contextPath %>/core/funcs/workflow/flowdesign/openWin.js"></script>
...
for(Map map : prcsList){
  ...
  if ("start".equals(flowType) ||"end".equals(flowType)  ) {
    ...
    String sOval = "<v:oval id="
      + prcsId +" table_id="
      + tableId + " flowType='"
      + flowType + "'  passCount='0'  onDblClick='Edit_Process2("+ tableId +")'  flowTitle='"
      + flowTitle + "' flowFlag='0'  readOnly='0'  receiverID=''  receiverName=''  fillcolor='"
      + fillcolor + "'  style='LEFT:" 
      + leftVml + "; TOP:" 
      + topVml + ";WIDTH: 120; POSITION: absolute; HEIGHT: 60;vertical-align:middle;cursor:pointer;TEXT-ALIGN:center;z-index:1' arcsize='4321f' coordsize='21600,21600' title='▲"
      + flowTitle + "\n" + prcsToTitle + "'>"; 
    ...
    if (!YHUtility.isNullorEmpty(condition)) {
      ...
      String prcsToTitle = "·下一步骤:" + prcsTo2;
      String sShapetype = "<v:shapetype   onDblClick='Edit_Process2("+ tableId +")'  id='type" + prcsId + "' coordsize='21600,21600' o:spt='4' path='m10800,l,10800,10800,21600,21600,10800xe'>";
      ...
      String sShape = "<v:shape type='#type" + prcsId + "' id='" + prcsId + "' table_id='" 
        + tableId + "' onDblClick='Edit_Process2("+ tableId +")'  flowType='"
        + flowType + "' passCount='0'  flowTitle='"
        + flowTitle + "' flowFlag='0'  readOnly='0' fillcolor='"
        + fillcolor + "' style='LEFT: "+ leftVml +"; TOP:"
        + topVml +"; WIDTH: 140; POSITION: absolute; HEIGHT: 80;z-index:1;vertical-align:middle;cursor:pointer;TEXT-ALIGN:center;' title=\"▲"+ flowTitle + "\n" + prcsToTitle  + condition.replace("<br>","\n").replace("<BR>" ,"\n") + "\">";
