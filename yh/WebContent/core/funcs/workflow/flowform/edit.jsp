...
var flowFormUrl = contextPath + "/yh/core/funcs/workflow/act/YHFlowFormAct";
var formViewUrl = contextPath + "/yh/core/funcs/workflow/act/YHFlowFormViewAct";
...
function Submit(){
  ...
  if(rtJson.rtState == "0"){
    location.href ='<%=contextPath%>/core/funcs/workflow/flowform/list.jsp?sortId=' + sortId;
...
function showView(seqId){
  var url = "<%=contextPath %>/core/funcs/workflow/flowform/formView.jsp?seqId=" + seqId ;
...
<br>
  ...
  <div align=center>
   ...
   <input type="hidden" id="dtoClass" name="dtoClass" value="yh.core.funcs.workflow.data.YHFlowFormType"/>
    <tr>
  ...
  <table width="450" height="28" align="center" class="TableList">
    <tr>
      ...
      <td class="TableData" nowrap align=left>
          ...
          <a href="javascript:location='import.jsp?formId=<%=seqId %>&sortId=<%=sortId %>'" title="可将一些备份的表单或优秀的表单导入">导入</a>&nbsp;&nbsp;
          ...
          <a href="javascript:location='versionlist.jsp?formId=<%=seqId %>&sortId=<%=sortId %>'"   id="historyButton">历史版本</a>&nbsp;
      </td>
    </tr>
  </table>
