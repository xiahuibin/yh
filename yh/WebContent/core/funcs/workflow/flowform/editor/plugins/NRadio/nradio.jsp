...
function Ok()
{
  ...
  oActiveEl = CreateNamedElement( oEditor, oActiveEl, 'IMG', {title: GetE('txtName').value.replace("\"","&quot;"),id:idtr,name:idtr,src:contextPath + "/core/funcs/workflow/flowform/image/radio.gif"});
...
<table width="100%" style="height: 100%">
		<tr>
			<td align="center">
          	...
          	<tr>
            <td>
              <input type="text" id="item11">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check11" onclick="check(11)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item12">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check12" onclick="check(12)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item13">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check13" onclick="check(13)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item14">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check14" onclick="check(14)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item15">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check15" onclick="check(15)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item16">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check16" onclick="check(16)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item17">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check17" onclick="check(17)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item18">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check18" onclick="check(18)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item19">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check19" onclick="check(19)">
            </td>
          </tr> 
          <tr>
            <td>
              <input type="text" id="item20">
            </td>
            <td align="center">
              <input type="checkbox" id="item_check20" onclick="check(20)">
            </td>
          </tr>
				</table>
			</td>
