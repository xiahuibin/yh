...
<script type="text/javascript">
 function doInit(){
     var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowReportAct/getReportPrivByRidAct.act?rId=<%=rId%>";
 ...
 function del(pid){
	 ...
	 var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowReportAct/delReportPrivByIdAct.act";
