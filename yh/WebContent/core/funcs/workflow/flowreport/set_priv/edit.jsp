...
<script Language="JavaScript">
 function doInit(){
	  var url = contextPath + "/yh/core/funcs/workflow/act/YHFlowReportAct/getReportPrivByPidAct.act?pId=<%=pId%>";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <form action="<%=contextPath %>/yh/core/funcs/workflow/act/YHFlowReportAct/updateReportPrivAct.act?rid=<%=rId %>&fId=<%=fId %>&pId=<%=pId %>" enctype="multipart/form-data"  method="post" name="form1" onSubmit="return CheckForm();">
