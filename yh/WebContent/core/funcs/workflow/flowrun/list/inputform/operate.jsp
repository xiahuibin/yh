...
<span id="handlerCompleteSpan" style='display:none'>
<input value="办理完毕" type="button" class="SmallButtonW" onclick="from.finishRun()"/>
<input value="保存" type="button" class="SmallButtonW" onclick="from.finishRun('1')"/>
<input value="保存并返回" type="button" class="SmallButtonC" onclick="from.finishRun('2')"/>
</span>
<span id="span5">
