...
<form name="ATTACHMENT1_formFile" id="ATTACHMENT1_formFile"action="<%=contextPath %>/yh/core/funcs/workflow/act/YHAttachmentAct/uploadFile.act" target="returnPage"  method="post" enctype="multipart/form-data">
