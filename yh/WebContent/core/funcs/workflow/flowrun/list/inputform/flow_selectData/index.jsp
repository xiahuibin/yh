...
<table border="0" width="100%" align="center">
         ...
         流水号：<input name="runId" id="runId" type=text value="">
         </td><td align=left>
         文号：<input name="runName" id="runName" type=text value="">
         </td></tr>
         <tr id="opTr"><TD>&nbsp;</TD><TD align="rigth"><input type=button value="查询" onclick="doQuery()"></TD></tr>
     </table>
</form>
</fieldset>
</div>
