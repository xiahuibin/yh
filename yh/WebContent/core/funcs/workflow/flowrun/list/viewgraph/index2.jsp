...
<script language="JavaScript" src="<%=contextPath %>/core/funcs/workflow/flowrun/list/viewgraph/set_main2.js"></script>
...
for(Map map : prcsList){
  ...
  if ("start".equals(flowType) ||"end".equals(flowType)  ) {
    ...
    if (!YHUtility.isNullorEmpty(condition)) {
      ...
      String prcsToTitle = "·下一步骤:" + prcsTo2;
      String sShapetype = "<v:shapetype    id='type" + prcsId + "' coordsize='21600,21600' o:spt='4' path='m10800,l,10800,10800,21600,21600,10800xe'>";
