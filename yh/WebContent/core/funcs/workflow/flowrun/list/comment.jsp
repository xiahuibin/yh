...
function doInit() {
  var url = contextPath+'/yh/core/funcs/workflow/act/YHFlowManageAct/getCommentMsg.act';
...
function saveComment() {
  ...
  var url = contextPath+'/yh/core/funcs/workflow/act/YHFlowManageAct/saveComment.act';
