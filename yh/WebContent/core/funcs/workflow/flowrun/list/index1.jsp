...
<table id="flow_table" border="0" width="100%" class="TableList"  style="clear:both;table-layout:fixed;" >
  <tr class="TableTr" id="flowTableHeader">
    <td id="RUN_ID_TD" onclick="sort('ASC')" style="cursor:pointer" class="TableHeader"  nowrap align="center" width=60>
      <b>流水号</b>
      <img id="RUN_ID_sortFlagImg" src="<%=imgPath %>/arrow_up.gif"/>
    </td>
    ...
    <option value="0" id="span3">所有流程类型</option>
      ...
      <td  class="TableHeader"  nowrap align="center"><b><span id="span1"></span></b></td>
