...
function htmlSubmit() {
  document.form1.action= contextPath + "/yh/core/funcs/workflow/act/YHWorkQueryAct/doQuery.act";
...
function flowReport(op) {
  $('OP').value = op;
  var url = contextPath + "/yh/core/funcs/workflow/act/YHWorkQueryAct/flowReport.act";
...
<!-- 显示分组字段 -->    
   ...
   <option value="runTime" >流程开始时间</option>
        ...
        <input type="checkbox" name="isHaveCount" id="isHaveCount" value="1" checked><label for="isHaveCount">是否小计</label>
      </td>
    </tr>
