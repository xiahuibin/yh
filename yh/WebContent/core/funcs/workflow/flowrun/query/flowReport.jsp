<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%@ page import="java.sql.Timestamp,java.util.Set,java.util.HashMap,java.util.List,yh.core.funcs.workflow.util.YHWorkFlowUtility,java.util.Map" %>
...
for (Map map : list) {
  ...
  <% 
  if (rowSpan == 2) {
    String ss = "<tr class=\"TableData\"><td>小计</td>";
    for (String tmp : s) {
