...
function trustAction(flowType , par){
  ...
  var url = contextPath + "/core/funcs/workflow/flowrun/list/others/"+page+".jsp?"+ par;
...
function exportRunSel() {
  ...
  var url = contextPath + "/yh/core/funcs/workflow/act/YHWorkQueryAct/getExcelData.act?runIds=" + runIds;
  window.open(url);
}
function exportZip() {
  var runIds =  getRunIds();
