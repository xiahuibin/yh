...
<script type="text/javascript" src="<%=contextPath %>/core/funcs/workflow/flowrun/destroy/js/destroy.js"></script>
...
function doInit(){
  ...
  var url =  contextPath + "/yh/core/funcs/workflow/act/YHWorkDestroyAct/getWorkList.act?" + param;
  var cfgs = {
    dataAction: url,
