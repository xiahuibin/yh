...
function doInit(){
    getFlowType();
	var url = "<%=contextPath%>/yh/core/funcs/workflow/act/YHDocumentsTypeAct/getDocumentsTypeDetail.act?seqId=<%=seqId%>";
    ...
    if(data.documentsFont){
      var urls = contextPath + "/yh/core/funcs/workflow/act/YHDocumentsTypeAct/getDocWordById.act?seqId="+data.documentsFont;
...
<br>
<form action="<%=contextPath%>/yh/core/funcs/workflow/act/YHDocumentsTypeAct/updateDocumentsTypeInfo.act"  method="post" name="form1" id="form1" onsubmit="">
  <table class="TableBlock" width="80%" align="center">
    ...
    <tr align="center" class="TableControl">
      <td colspan=4 nowrap>
        ...
        <input type="button" value="返回" class="BigButton" onClick="location='<%=contextPath %>/core/funcs/workflow/flowrun/documentsType/manage.jsp'">
      </td>
    </tr>
  </table>
</form>
