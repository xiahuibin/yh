<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="yh.core.funcs.workflow.data.YHFlowType,java.util.List"%>
...
<script type="text/javascript">
   ...
   function doInit(){
     ...
     var url =  contextPath + "/yh/core/funcs/workflow/act/YHFlowRunAct/getRunList.act?sortId=<%=sortId%>";
