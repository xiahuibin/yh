...
<TABLE>
 ...
 <TR align="center">
 	<TD align="center" valign="top">
      ...
      <param name="movie" value="<%=contextPath %>/core/funcs/workflow/workflowUtility/columnCharing.swf" />
      <param name="quality" value="high" />
      <param name="bgcolor" value="#869ca7" />
      <param name="allowScriptAccess" value="sameDomain" />
      <embed src="<%=contextPath %>/core/funcs/workflow/workflowUtility/columnCharing.swf" quality="high" bgcolor="#869ca7"
