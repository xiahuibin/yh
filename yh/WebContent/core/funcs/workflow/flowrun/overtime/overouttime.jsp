...
function viewDetail(userId , flowId) {
  var url = contextPath + "/core/funcs/workflow/flowrun/overtime/viewDetail.jsp?" 
     + "flowId=" + flowId
      + "&userId=" + userId
...
<td>
<center>
<input type="button"  style="display:<%= data.isEmpty() ? "none" : ""%>"  class="BigButton"  value="返回" onclick="javascript:window.location= contextPath + '/core/funcs/workflow/flowrun/overtime/overtotal.jsp?sortId=<%=sortId %>&skin=<%=skin %>'">
</center></td></tr>
  </table>
  ...
  <div><input   class="BigButton"  type="button" value="返回 " class="Log_submit" onclick="javascript:window.location= contextPath + '/core/funcs/workflow/flowrun/overtime/overtotal.jsp?sortId=<%=sortId %>&skin=<%=skin %>'"/></div>
  </div>
</body>
</html>