...
function optRender(cellData, recordIndex, columIndex) {
  ...
  var html = "<a id=\"a1_" + recordIndex + "_" + columIndex + "\" href=\"javascript:showReader('"+ diaId + "');\">阅读人员</a>" + "&nbsp;";
  if(!isLocked(cutDate(diaDate))){
    html += "<a id=\"a2_" + recordIndex + "_" + columIndex + "\" href=\"javascript:editDiary('"+ diaId + "');\">编辑</a>";
  }
  return html; 
}
/**
