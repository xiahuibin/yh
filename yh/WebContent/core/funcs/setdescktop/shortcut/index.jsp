...
function  doInit(){
  var url = "<%=contextPath%>/yh/core/funcs/setdescktop/shortcut/act/YHShortcutAct/getFuncs.act";
...
function submitForm(){
  var url = "<%=contextPath%>/yh/core/funcs/setdescktop/shortcut/act/YHShortcutAct/modifyShortCut.act?sortCut=" + selectValue;
  var rtJson = getJsonRs(url);
  if (rtJson.rtState == "0") {
