...
<div id="navPanel">
  <div id="navMenu">
    <a href="left.jsp?SORT_ID=0&FILE_SORT=1" target="file_tree" title=" 维度管理" hidefocus="hidefocus"><span><img src="<%=contextPath %>/core/funcs/filefolder/images/file_folder.gif" width="16" height="16" align="middle" /> 维度管理</span></a>
  </div>
