...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    ...
    <td class="Big"><img src="<%=imgPath%>/system.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3"> 错误子菜单列表</span>
    </td>
  </tr>
</table>
...
<table class="MessageBox" align="center" width="340">
  <tr>
    <td class="msg info">
      <div class="content" style="font-size:12pt">没有定义错误的子菜单</div>
    </td>
  </tr>
</table>
<br>
