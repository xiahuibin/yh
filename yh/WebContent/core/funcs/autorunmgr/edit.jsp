...
<script type="text/javascript">
  ...
  function doInit(){
    ...
    if(rtJson.rtState == "0"){
      ...
      $("intervalSecondTemp").value = rtJson.rtData.intervalSecond/60;
    }
  }
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/edit.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3"> 编辑间隔任务</span>
    </td>
  </tr>
</table>
...
<table class="TableBlock" width="450" align="center">
   ...
   <tr class="TableData">
    ...
    <td>
        ...
        <input type="text" id="intervalSecondTemp"  class="BigInput" size="5" maxlength="3" value="10"> 分钟   <font color="red">*</font> </td>
   </tr>
   <tr class="TableData">
    <td>是否启用：</td>
    <td>
