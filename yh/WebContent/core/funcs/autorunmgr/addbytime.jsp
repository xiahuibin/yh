...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/edit.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3"> 注册定点任务</span>
    </td>
  </tr>
</table>
...
<table class="TableBlock" width="450" align="center">
   ...
   <tr class="TableData">
    <td>执行间隔：</td>
    <td>
        <input type="hidden" id="intervalSecond" name="intervalSecond" class="BigInput" size="5" maxlength="3" value="259200"> 
        <input type="text" id="intervalSecondTemp"  class="BigInput" size="5" maxlength="3" value="3" onblur="trans2intervalSecond(this)"> 天 <font color="red">*</font>   </td>
   </tr>
     <tr class="TableData">
    <td>执行时间：</td>
    <td>
        <select id="hour"   style="width:40px"></select>:<select id="min" style="width:40px"></select>
        <input type="hidden" id="runTime" name="runTime" class="BigInput" size="10" maxlength="10" value=""> </td>
   </tr>
   <tr class="TableData">
    <td>是否启用：</td>
    <td>
