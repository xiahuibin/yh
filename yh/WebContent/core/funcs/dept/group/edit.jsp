...
function doInit(){
  var url = "<%=contextPath%>/yh/core/funcs/dept/act/YHUserGroupAct/getUserGroupEdit.act";
  var rtJson = getJsonRs(url, "seqId="+seqId);
  if(rtJson.rtState == "0"){
    for(var i = 0; i < rtJson.rtData.length; i++){
  	  $("groupName").value = rtJson.rtData[i].groupName;
  	  $("orderNo").value = rtJson.rtData[i].orderNo;
  	  groupName = rtJson.rtData[i].groupName;
  	  orderNo = rtJson.rtData[i].orderNo;
  	}
  }else{
    alert(rtJson.rtMsrg);
  }
...
function commit(){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/dept/act/YHUserGroupAct/updateUserGroup.act?seqId="+seqId;
...
<form name="form1" id="form1">
  <table class="TableBlock" width="400" align="center">
    <tr>
      <td nowrap class="TableContent" width="80">用户组名称：</td>
