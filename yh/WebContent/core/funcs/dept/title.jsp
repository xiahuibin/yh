...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    ...
    <td align="right">
      <input type="button" value="新建部门/成员单位" class="BigButtonC" onClick="parent.deptinput.location='deptinput.jsp';" title="新建部门/成员单位">&nbsp;&nbsp;
      <input type="button" value="导入" class="BigButton" onClick="importDept();" title="导入部门/成员单位">&nbsp;&nbsp;
      <input type="button" value="导出" class="BigButton" onClick="exportDept();" title="导出部门/成员单位">&nbsp;&nbsp;&nbsp;&nbsp;
    </td>
    </tr>
</table>
</body>
