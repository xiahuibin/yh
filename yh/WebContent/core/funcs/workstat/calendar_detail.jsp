...
function doOnload(){
  ...
  var param="userId=<%=userId%>&startDate=<%=startDate%>&endDate=<%=endDate%>&status=1";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/views/attendance.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">  &nbsp;日程安排（完成） </span><br>
    </td>
  </tr>
</table>
<br>
