...
<head>
<title>设置编辑区</title>
<link  rel="stylesheet"  href  ="<%=contextPath%><%=moduleContextPath %>/flowtype/setprint/js/style.css">
...
<script  type="text/Javascript"  src="<%=contextPath%><%=moduleContextPath %>/flowtype/setprint/js/print.js"  ></script>
<script>
  var flow_id=<%=flowId%>;
  var FONT_FAMILY = "宋体";
  var FONT_SIZE = "12pt";
  ...
  var selectData;
	function doInit(){
	  ...
	  function addOption(){
	        var url = contextPath + "<%=moduleSrcPath %>/act/YHFlowReportAct/getListItemAct.act?fId="+flow_id;
