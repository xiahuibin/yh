...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/notify_new.gif" align="absmiddle"><span class="big3"> 新建流程</span><br>
    </td>
  </tr>
</table>
<br>
...
<input type="button"  value="新建流程" class="BigButtonC" onClick="editFlow()" title="新建流程">
</div>
<br>
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/notify_open.gif" align="absmiddle"><span class="big3"> 管理流程</span><br>
    </td>
  </tr>
</table>
<div id="search">
<input type="text" id="kword" name="kword" value="流程检索..." onfocus="interval=setInterval(CheckSend,100);" onblur="clearInterval(interval);if(KWORD.value=='')KWORD.value='流程检索...';" class="SmallInput" /><img id="search_icon" src="<%=imgPath %>/quicksearch.gif" align=absmiddle style="cursor:pointer;" />
</div>
<br/>
<div id='sortList'></div>
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/edit.gif" align="absmiddle"><span class="big3"> 其他操作</span><br>
    </td>
  </tr>
</table>
<br>
<div align="center">
<input type="button" class="BigButton" onclick="parent.mainFrame.location='setTrans/index.jsp'" value="工作移交"><br><br>
</div>
<%} %>
</body>
</html>