...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/notify_new.gif"/><span class="big3">修改收文</span>
    </td>
  </tr>
</table>
<form action="<%=contextPath%>/yh/core/funcs/doc/receive/act/YHDocReceiveAct/update.act" id="form1" method="post" name="form1" >
<table class="TableBlock" width="70%" align="center">
  ...
  <!--  <tr>
	...
	<tr>
    <td nowrap class="TableContent" width="120">承办单位:<font style="color:red">*</font></td>
    <td nowrap class="TableData">
