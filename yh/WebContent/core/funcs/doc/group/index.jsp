...
function doInit(){
  var count = 0;
  var url = "<%=contextPath%>/yh/core/funcs/doc/group/act/YHDeptGroupAct/getDeptGroups.act";
  ...
  if(rtJson.rtState == "0"){
    var table=new Element('table',{"width":"70%","class":"TableBlock","align":"center"})
		.update("<tbody id='tbody'><tr class='TableHeader' align='center'>"
				+"<td nowrap align='center' width='200'>部门组名称</td>"
...
function deleteSingle(seqId){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/doc/group/act/YHDeptGroupAct/deleteDeptGroup.act";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/notify_new.gif" align="absmiddle"><span class="big3">&nbsp;新建部门组</span><br>
    </td>
  </tr>
</table>

<div align="center">
<input type="button" value="新建部门组" class="BigButtonC" onClick="location='edit.jsp';" title="创建新的部门组">
</div>
<br>
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
...
<table class="MessageBox" align="center" width="280">
  <tr>
    <td class="msg info">
      <div class="content" style="font-size:12pt">无定义的部门组</div>
    </td>
  </tr>
</table>
</div>
