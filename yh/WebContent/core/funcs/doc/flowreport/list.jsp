...
<script type="text/javascript">
 function doInit(){
   var fId='<%=fId%>';
	 if(fId!=""){
		  var url = contextPath + "<%=moduleSrcPath %>/act/YHFlowReportAct/getReportAct.act?fId="+fId;
 ...
 function del(rid){
	  if(window.confirm("确认要删除该报表 ？")){
		  var url = contextPath + "<%=moduleSrcPath %>/act/YHFlowReportAct/delReportByIdAct.act";
