...
<form action="<%=contextPath %><%=moduleSrcPath %>/act/YHFlowReportAct/addReportPrivAct.act?rid=<%=rId %>&fId=<%=fId %>" enctype="multipart/form-data"  method="post" name="form1" onSubmit="return CheckForm();">
