...
function doInit(){
  ...
  if(prcsJson.length > 0){
	    ...
	    var property = "javascript:parent.location.href = \""+ contextPath + moduleContextPath +"/flowdesign/viewlist/setproperty/index.jsp?" + tmp + "\"";
	    var priv = contextPath + moduleContextPath +"/flowdesign/viewlist/setPriv/setOperatePriv.jsp?" + tmp;
	    var setField = contextPath + moduleContextPath +"/flowdesign/viewlist/setField/setField.jsp?" + tmp;
	    var hiddenField = contextPath + moduleContextPath +"/flowdesign/viewlist/setField/setHiddenField.jsp?" + tmp;
	    var setCondition = contextPath + moduleContextPath +"/flowdesign/viewlist/setCondition/setCondition.jsp?" + tmp;
        var setDoc = contextPath + moduleContextPath +"/flowdesign/viewlist/setDoc/setDoc.jsp?" + tmp;
