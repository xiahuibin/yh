...
function doInit(){
  ...
  var jso = [
             {contentUrl:"<%=contextPath %><%=moduleContextPath %>/flowrun/overtime/overquery.jsp?sortId="+sortId+"&skin=<%=skin%>",  useIframe:true}
              ,{contentUrl:"<%=contextPath %><%=moduleContextPath %>/flowrun/overtime/overtotal.jsp?sortId="+sortId+"&skin=<%=skin%>", useIframe:true}
           ];
