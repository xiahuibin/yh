...
<a href="javascript:from.openPrintForm()"><img src="<%=imgPath %>/print.gif"/>打印登记信息</a></span>
<span>
...
<span>
<a href="javascript:void(0)" style="display:none" id="moreA" onclick="showMore()">更多>></a></span>&nbsp; 
</span>
</DIV>


<DIV style="FLOAT: right">
<span id="turnSpan"  style='display:none'><input value="下一步" id="turnNextButton" class="SmallButton" style="display:none" type="button" onclick="from.saveForm(1)"/></span>
<span id="span2">
...
<span id="span5">
<span id="cancleSpan" style="display:none"><input value="作废"  class="SmallButtonW" type="button" onclick="from.cancelRun();"/></span>
</span>
<span id="span6">
