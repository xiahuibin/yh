...
function doSubmit(){ 
		...
		var query = "dwName=" + encodeURIComponent($('dwName').value)   + "&indexStyle=" + encodeURIComponent($('indexStyle').value);    
		location.href = "<%=contextPath %><%=moduleContextPath %>/flowrun/docword/search.jsp?" + query;
