...
<script type="text/javascript" src="<%=contextPath %>/core/js/smartclient.js"></script>
  <script type="text/javascript" src="<%=contextPath %><%=moduleContextPath %>/lables/messages.js"></script>
...
function doInit(){
  ...
  var url = contextPath + "<%=moduleSrcPath %>/act/YHFlowReportAct/getReportListAct.act";
