...
function doSubmit(event) {
  if(checkForm()&& checkWord()){
    ...
    var rtJson = getJsonRs(contextPath + "/yh/core/funcs/doc/send/act/YHSubjectTermAct/insertWord.act?treeId="+treeId, mergeQueryString($("form1")));
    if (rtJson.rtState == 0) {
...
function deptFunc(){
  var url = "<%=contextPath%>/yh/core/funcs/doc/send/act/YHWordTreeAct/selectWordToAttendance.act";
