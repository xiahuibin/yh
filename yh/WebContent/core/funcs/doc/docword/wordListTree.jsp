...
function doInit(){
  ...
  var url = contextPath + "/yh/core/funcs/doc/send/act/YHWordTreeAct/getTree.act?id=";
...
function test(id){
  ...
  if(parentId != '0'){
    window.parent.wordInput.location = "<%=contextPath%>/core/funcs/doc/docword/wordEdit.jsp?treeId=" + id;
  }else{
  	var rtJson = getJsonRs(contextPath + "/yh/core/funcs/doc/send/act/YHSubjectTermAct/getSeqId.act");
  	if(rtJson.rtState=="0"){
