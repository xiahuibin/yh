...
<script type="text/javascript" src="MultiWordSelect.js"></script>
...
function CheckSend()
{
  ...
  if(key!=kword.value && kword.value!="")
  {
     ...
     if($('search_icon').src.indexOf(imgPath + "/quicksearch.gif")>=0)
     {
         ...
         $('search_icon').onclick=function(){kword.value='按名称搜索主题词...';$('search_icon').src= imgPath + "/quicksearch.gif";$('search_icon').title="";$('search_icon').onclick=null;};
     }
  }
...
<div style="clear: both;text-align: center;">
  <input type="text" id="kword" name="kword" value="按名称搜索主题词..."  onfocus="ctroltime=setTimeout(CheckSend,100);" onblur="clearTimeout(ctroltime);if(this.value=='')this.value='按名称搜索主题词...';"  class="SmallInput" style="color:#A0A0A0;width:145px;"><img id="search_icon" src="<%=imgPath %>/quicksearch.gif" align=absmiddle style="cursor:pointer;">
  <br>
  <br>
