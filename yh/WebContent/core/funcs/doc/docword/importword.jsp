...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <b>请指定用于导入的CSV文件：</b>
  <form name="form1" id="form1" action="<%=contextPath%>/yh/core/funcs/doc/send/act/YHSubjectTermAct/importWord.act" method="post" enctype="multipart/form-data">
...
<div id="msrg"></div>
  ...
  <div align="center" id="turnDiv">
   <input type="button" value="返回" class="BigButton" onClick="location='<%=contextPath%>/core/funcs/doc/docword/importword.jsp?flag=1';" title="返回">
</div>
</body>
</html>