...
function downCSVTemplet(){
  var downUrl = "<%=contextPath%>/yh/core/funcs/person/act/YHSecureCardAct";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
    <tr>
      <td class="Big"><img src="<%=imgPath%>/sys_config.gif" align="absmiddle"><span class="big3">&nbsp;批量绑定用户和卡</span><br>
      </td>
    </tr>
  </table>
  <br>
  ...
  <b>请指定用于导入的CSV文件：</b><a href="#" onclick="downCSVTemplet();">下载模板文件 </a>
  <form id="form1" name="form1" method="post" action="<%=contextPath%>/yh/core/funcs/person/act/YHSecureCardAct/impSecureCardInfoToCsv.act" enctype="multipart/form-data">
    <input type="file" name="csvFile" id="csvFile" class="BigInput" size="30">
    <input type="hidden" name="FILE_NAME">
    <input type="hidden" name="GROUP_ID" value="">
    <input type="button" value="批量绑定" class="BigButton" onclick="importSecureCard();">
  </form>
  </div>
</div>
