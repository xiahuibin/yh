...
function doInit(){
  ...
  url = contextPath + "/yh/core/funcs/person/act/YHPersonAct/getRoles.act";
...
<div id="rightRole">
<div id="hasRole">
<div id="title" class="header" >选择角色<input type=button class="SmallButtonW" value="确定" onclick="window.close()"/></div>
