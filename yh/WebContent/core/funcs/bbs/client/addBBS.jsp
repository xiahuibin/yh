...
<%@ page language="java" import="oa.core.funcs.bbs.act.BBSUtil" %>
<%
...
<table border="0" width="90%" cellspacing="0" cellpadding="3">
  <tbody><tr>
    <td><img src="/yh/core/styles/imgs/green_plus.gif"><span class="big1" id="newTitle"> 新建帖子</span>&nbsp;&nbsp;
    </td>
  </tr>
</tbody></table>
...
<input type="hidden" name="parent" id="parent" value="<%=request.getParameter("commentId")==null?0:request.getParameter("commentId")%>"/>
    ...
    <tr>
      ...
      　</td>
       <td class="TableData">
        ...
        <input type="text" name="subject" id="subject" size="55" maxlength="200" class="BigInput" value="请输入新闻标题..." style="color: rgb(136, 150, 160); " onmouseover="if($F('subject')=='请输入新闻标题...') document.getElementById('subject').style.color='#000000';" onmouseout="if($F('subject')=='请输入新闻标题...') document.getElementById('subject').style.color='#8896A0';" onfocus="if($F('subject')=='请输入新闻标题...') {document.getElementById('subject').value='';document.getElementById('subject').style.color='#000000';}">
      <%}else{ %>
        <input type="text" name="subject" id="subject" size="55" maxlength="200" class="BigInput" value="Re:<%=request.getParameter("subject") %>"/>
      <%} %>
      </td>
    </tr>
	<!-- 
    ...
    <tr align="center" class="TableControl">
      <td colspan="2" nowrap="">
        ...
        <input type="hidden" name="op" value="">
         ...
         <input type="button" value="发布" class="BigButton" onclick="bbsForm.submit();">&nbsp;&nbsp;
