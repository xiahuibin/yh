...
<DIV class=content 
style="FONT-SIZE: 12pt">附件上传失败！</DIV></TD></TR></TBODY></TABLE><BR>
<DIV align=center>
<SCRIPT>
   if(parent.mail_menu)
      parent.mail_menu.location.reload();
</SCRIPT>
<INPUT class=SmallButtonW onclick="location='<%=contextPath %>/core/funcs/email/outbox/index.jsp'" type=button value=返回> 
</DIV>
</body>
</html>