...
function loadPage(recordIndex,total){
  ...
  var url = urlPre + "?mailId="+emialId+"&seqId=" + emailBodyId + "&total=" + total + "&recordIndex=" + recordIndex + "&boxId=<%=boxId%>";
  parent.location = url;
}
...
<table width="100%" cellpadding="3">
  <tr>
   ...
   <input type="button" value="返回" class="BigButtonA" onClick="parent.location='<%=contextPath%>/core/funcs/email/inbox/index.jsp?boxId=0&pageNum=0&pageRows=10'">
    </td>
  </tr>
</table>
</body>
