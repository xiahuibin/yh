...
<frameset rows="*,40" cols="*" frameborder="no" framespacing="0">
    <frame src="readMail.jsp?pageStart=&seqId=<%=seqId%>&mailId=<%=mailId%>&boxId=<%=boxId%>&field=&ascDec=" name="mail_view" scrolling="auto">
    <frame src="control.jsp?pageStart=&seqId=<%=seqId%>&boxId=<%=boxId%>&field=&ascDec=&total=<%=total%>&recordIndex=<%=recordIndex%>" name="mail_control" scrolling="no" FRAMEBORDER="no">
</frameset>
