...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=contextPath %>/core/funcs/filefolder/images/folder_search.gif" align="middle"><b>&nbsp;<span class="Big1" id="folderName"> </span>- 查询文件</b><br>
    </td>
  </tr>
</table>
...
<form action="<%=contextPath %>/core/funcs/personfolder/personFolderSearch.jsp" name="form1" id="form1" >
<table class="TableBlock" width="450" align="center">
  ...
  <tr >
      <td nowrap class="TableControl" colspan="2" align="center">
          ...
          <input type="button" value="返回" class="BigButton" onclick="location='<%=contextPath %>/core/funcs/personfolder/folder.jsp?seqId=<%=seqId%>&FILE_SORT=1&SORT_ID=11'">
      </td>
  </tr>
</table>
</form>
