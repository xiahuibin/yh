...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath%>/email_close.gif" WIDTH="20" HEIGHT="20" align="absmiddle"><span class="big3"> 未确认提醒息</span><br>
    </td>
...
<table class="MessageBox" align="center" width="300">
  <tr>
    <td class="msg info">
      <div  style="font-size:12pt;" class="content">无未确认的提醒息</div>
    </td>
  </tr>
</table>
</div>
