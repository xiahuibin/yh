...
<script type="text/javascript">
  ...
  function keepSend(id){
    location=contextPath + '/core/funcs/sms/sendsms.jsp?toId='+id;
  }
</script>
</head>
<body  onload="">
...
<div align="center">
 <input type="button" id="button1" name="button1" value="继续发短信" class="BigButton" onClick="keepSend('<%=seqId%>')"> &nbsp;&nbsp;
  <input type="button" value="返回" class="BigButton" onClick="location='<%=contextPath %>/core/funcs/sms/sendsms.jsp'">
</div>
</body>
</html>