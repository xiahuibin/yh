...
function Init(){
  var requestUrl = "<%=contextPath%>/yh/core/funcs/attendance/manage/act/YHManageOutAct/updateReason.act";
...
<table class="TableBlock"  width="450" align="center" >
   ...
   <tr>
    <td nowrap  class="TableControl" colspan="2" align="center">
      ...
      <input type="hidden" id="checkOut" value="<%=request.getParameter("checkOut") %>" name="checkOut">
