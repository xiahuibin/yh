{
  tbar: [{
    ...
    handler: function(e, t, p) {
      openUrl({
        text: "财务应付单提醒",
        url: contextPath + "/springViews/erp/finance/financeRemind/financeInShowDetial.jsp"
      });
    }
  }],
  ...
  "items":[{
    xtype: "grid",
    loader: {
      url: contextPath + "/yh/core/funcs/notify/act/YHNotifyShowAct/queryAllFinanceOutRemind.act"
    },
    rowRender: function(i, e) {
      ...
      function deskFinanceInRemind(seqId){
        ...
        var URL = contextPath + '/springViews/erp/finance/financeRemind/financeInShowDetial.jsp?status='+e.status;
      ...
      return a.append("应收单编号：").append("【").append(code).append("】").append("&nbsp;").append("应收单状态：").append(status);
    }
  }],
  "xtype": "panel",
  height: "auto",
