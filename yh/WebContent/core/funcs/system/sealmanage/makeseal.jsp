...
function doInit(){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/system/sealmanage/act/YHSealAct/getCounter.act";
  var seal_id = "20103"
...
function SelBMPFile_onclick(){
  ...
  $("SealHeight").value = vBmpHeightMM;                  //界面上的input框：图片高度
}
...
function insertSealLog(){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/system/sealmanage/act/YHSealLogAct/addSealLog.act";
...
function insertSeal(){
  ...
  var sealData = $('SEAL_DATA').value.replace(/\+/g, '%2B');
  var deptId = $('dept').value;
  var url = "<%=contextPath%>/yh/core/funcs/system/sealmanage/act/YHSealAct/addSeal.act";
...
<table class="TableBlock" border=0 align="center" width=80%>
  ...
  <tr>
    ...
    <td class="TableData"><select name="SealZoom" id="SealZoom">
        <option value="1">图片于印章等大</option>
        <option value="2" selected>图片2倍于印章</option>
