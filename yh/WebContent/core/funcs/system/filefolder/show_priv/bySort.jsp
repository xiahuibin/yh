...
function USER_ID(){
	...
	.update("<tbody id='tbody'><tr class='TableHeader' style='font-size:10pt'>"
			...
			+"<td nowrap align='center'>编辑权限</td>"	
			+"<td nowrap align='center'>删除权限</td>"			
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=contextPath %>/core/funcs/filefolder/images/notify_open.gif" align="absmiddle"><span class="big3"> 按文件夹显示</span>
