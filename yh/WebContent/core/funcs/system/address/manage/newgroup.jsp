...
function commit(){
  ...
  var url = "<%=contextPath%>/yh/core/funcs/system/address/act/YHAddressAct/addGroup.act";
  var rtJson = getJsonRs(url, "privUser="+privUser+"&privDept="+privDept+"&privRole="+privRole+"&groupName="+encodeURIComponent(groupName)+"&orderNo="+encodeURIComponent(orderNo));
  if(rtJson.rtState == "0"){
