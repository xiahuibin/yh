...
var seqId = "<%=seqId%>";
  ...
  function bindSmsBody(seqId){
    var url = contextPath + "/yh/core/funcs/message/act/YHMessageAct/showMessageBody.act?seqId=" + seqId;
    ...
    if(rtJson.rtState == "0"){
      ...
      var type = "<IMG alt=\"" + getSmsTypeDesc(smsBody.messageType) + "\" src=\"" + "<%=imgPath%>" + "/sms/sms_type1.gif\" align=absMiddle>&nbsp;&nbsp;" + getSmsTypeDesc(smsBody.messageType);
