...
<table cellscpacing="1" cellpadding="3" width="100%">
  <tr>
    <td class="Big">
      <img src="<%=imgPath%>/msg_back.gif"></img><span class="big3"> 已接收的短信息</span>
    </td>
...
<table cellscpacing="1" cellpadding="3" width="100%" class="TableList">
  ...
  <TABLE class=TableBlock width="100%" align=center>
	...
	href="javascript:delShortCut(2,1,'确定要删除所有已读短信吗？');">删除所有已读短信</A>&nbsp;&nbsp; <IMG 
	src="<%=imgPath%>/sms/sms_delete.gif"> <A title=删除所有已接收的短信息 
	href="javascript:delShortCut(1,1,'确定要删除所有短信吗？');;">全部删除</A>&nbsp;&nbsp; <IMG 
	src="<%=imgPath%>/sms/sms_open.gif"> <A title=标记所有短信息为已读 
...
<div id="acceptSms" style="display:none;">
  ...
  <tr>
    <td class="msg info">
      <div class="content" style="font-size:12pt">无已接收的短信息</div>
    </td>
  </tr>
</table>
</div>
