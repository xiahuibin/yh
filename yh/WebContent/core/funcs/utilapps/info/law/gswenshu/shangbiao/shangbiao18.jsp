...
<table width="500" border="0" cellspacing="1" cellpadding="3" align="center" class="TableBlock">
  ...
  <tr> 
    ...
    <td height="27" class="TableHeader">
      ...
      <div align="center">商标注销申请书</font></div>
...
<p >1．应按规定的格式逐项填写，注意将申请注销的注册商标的注册号、分类及名称填写准确。</p>

        <p >2．商标注销申请书的理由一项应详细陈述不再需要使用该注册商标或其他申请注销商标的事实和理由。</p>

        <p >3．随商标注销申请应当向商标局交回原商标注册证。</p>
...
'>商标注销申请书</p>
        ...
        <p >你局核准注册的第<u><span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
          ...
          </span></u>类商品/服务上的<u>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </u>商标，现申请注销。</p>
