...
<table width="500" border="0" cellspacing="1" cellpadding="3" align="center" class="TableBlock">
  ...
  <tr> 
    ...
    <td height="27" class="TableHeader"> 
      ...
      <div align="center">身份证明文件</font></div>
  ...
  <tr> 
    ...
    <td height="54" valign="top" class="TableData">
      ...
      <ol>
        ...
        <li><a href="shenfenzm/shenfeng00.jsp">代表人身份证明书</a></li>

        <li><a href="shenfenzm/shenfeng01.jsp">法定代表人身份证明书</a></li>

        <li><a href="shenfenzm/shenfeng02.jsp">法定代表人证明书</a></li>
