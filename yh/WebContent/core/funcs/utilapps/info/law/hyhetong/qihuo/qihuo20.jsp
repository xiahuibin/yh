...
<table width="500" border="0" cellspacing="1" cellpadding="3" align="center" class="TableBlock">
  <tr> 
    <td height="27" class="TableHeader"> 
      <div align="center">年度报告(4)</font></div>
    </td>
  </tr>
  <tr> 
    <td height="54" valign="top" class="TableData">
      <p>附件二：</p>
      <p align=center >公司股份变动情况表</p>
      <p align=right >数量单位：股</p>
      <table border=1 cellspacing=0 cellpadding=0 width=646>
        <tr> 
          <td width=171 valign=top >&nbsp; </td>
          <td width=104 valign=top > 
            <p align=center >本次变动前</p>
          </td>
          <td width=272 colspan=6 valign=top > 
            <p align=center >本次变动增减（+，-）</p>
          </td>
          <td width=99 valign=top > 
            <p align=center >本次变动后</p>
          </td>
        </tr>
        <tr> 
          <td width=171 valign=top >&nbsp; </td>
        ...
        <tr> 
          ...
          <td width=104 valign=top >&nbsp; </td>
          <td width=272 colspan=6 valign=top >&nbsp; </td>
          <td width=99 valign=top >&nbsp; </td>
        </tr>
        <tr> 
          <td width=171 valign=top > 
      ...
      <p >注：公司如有基金配售股份、柜台交易公司内部职工股份、战略投资者配售股份、一般法人配售股份，应分别披露其股份数额。</p>
      <p>　　<BR>
        　　<BR>
        　　　　 </p>
    </td>
