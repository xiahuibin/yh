...
<table width="500" border="0" cellspacing="1" cellpadding="3" align="center" class="TableBlock">
  ...
  <tr> 
    ...
    <td height="27" class="TableHeader">
      ...
      <div align="center">民事裁定书（终结特别程序用）</font></div>
...
　　申请人……（写明姓名、性别、出生年月日、民族、籍贯、职业、工作单位和职务、住址）。<BR> 

　　本院审理的申请人×××……（写明案由）一案，因……（写明终结特别程序的理由）。依照……（写明裁定所依据的法律条款项）的规定，裁定如下：<BR> 
