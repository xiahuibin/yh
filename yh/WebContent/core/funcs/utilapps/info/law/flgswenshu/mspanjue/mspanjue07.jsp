...
<table width="500" border="0" cellspacing="1" cellpadding="3" align="center" class="TableBlock">
  ...
  <tr> 
    ...
    <td height="27" class="TableHeader">
      ...
      <div align="center">民事判决书（指定监护人案件用）</font></div>
...
　　起诉人×××不服指定监护一案，本院依法进行了审理，现已审理终结。<BR> 

　　……（写明起诉的理由和请求）。　　<BR> 

　　本院认为，……（写明撤销原指定监护的理由）。依照……（写明判决所依据的法律条款项）的规定，判决如下：<BR> 

　　一、撤销××××（单位名称）指定×××为×××的监护人的指定；<BR> 
