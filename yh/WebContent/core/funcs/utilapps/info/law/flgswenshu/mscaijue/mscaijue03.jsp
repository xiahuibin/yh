...
<table width="500" border="0" cellspacing="1" cellpadding="3" align="center" class="TableBlock">
  ...
  <tr> 
    ...
    <td height="27" class="TableHeader">
      ...
      <div align="center">民事裁定书（中止或终结诉讼用）</font></div>
...
　　（当事人及其他诉讼参加人的列项和基本情况的写法，与一审民事判决书样式相同。如果当事人已经死亡，其基本情况只写姓名、性别和死亡年月日。）<BR> 

　　本院在审理……（写明当事人姓名或名称和案由）一案中，……（写明中止或终结的事实根据）。依照……（写明裁定所依据的法律条款项）的规定，裁定如下：<BR> 
