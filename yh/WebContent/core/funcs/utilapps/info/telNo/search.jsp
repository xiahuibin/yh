...
var pageMgr;
function Init(){
  var telNo = encodeURI("${param.telNo }");
  var area = encodeURI("${param.area }");
  var requestURL;
  var cfgs;
  if(telNo.trim() != ""){
    requestURL = "<%=contextPath%>/yh/core/funcs/utilapps/info/telNo/act/YHTelNoAct/searchTelNo.act?telNo="+telNo;
    cfgs = {
    ...
    requestURL = "<%=contextPath%>/yh/core/funcs/utilapps/info/telNo/act/YHTelNoAct/searchAreaInfo.act?area="+area;
    cfgs = {
      dataAction: requestURL,
      container: "listDiv",
      colums: [
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="/yh/core/styles/imgs/menuIcon/infofind.gif" align="absmiddle"><span class="big3"> 电话区号查询结果</span>
    </td>
  </tr>
</table>
