...
function Init(){
  ...
  var cfgs;
  if(province.trim() != ""){
	  requestURL = "<%=contextPath%>/yh/core/funcs/utilapps/info/postNo/act/YHPostNoAct/searchProvince.act?province="+province;
	  cfgs = {
	    ...
	    colums: [
	       ...
	       {type: "text", name: "postNo", text: "邮编", width: 180,align: 'center'} ]
	  };
  }
  else if(area != ""){
	  requestURL = "<%=contextPath%>/yh/core/funcs/utilapps/info/postNo/act/YHPostNoAct/searchArea.act?area="+area;
	  cfgs = {
      dataAction: requestURL,
      container: "listDiv",
      colums: [
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big">
      <img src="/yh/core/styles/imgs/menuIcon/infofind.gif" align="absmiddle"><span class="big3" id="pro"> 邮政编码 -</span>
    </td>
  </tr>
</table>
