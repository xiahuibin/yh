...
function doInit(){ 
  ...
  var url = contextPath + "/yh/core/funcs/allreport/act/YHDataReportAct/getReportListAct.act";
...
function getModule(module) {
  ...
  for (var i = 0 ;i < lists.length ;i ++) {
    ...
    if (list) {
      ...
      div += "<li><a href=\"show_report.jsp?rId="+listId+"\" title=\"点击打开报表\">"+listName+"</a>&nbsp;&nbsp;&nbsp;";
      div += "</li>";
    }
  }
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/green_arrow.gif" align="absmiddle"><span class="big3" id="span"> 数据报表 </span>
    </td>
  </tr>
</table>
