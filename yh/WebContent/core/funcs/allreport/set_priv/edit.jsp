...
<script Language="JavaScript">
 function doInit(){
    var url = contextPath + "/yh/core/funcs/allreport/act/YHReportPrivAct/getReportPrivByPidAct.act?seqId=<%=seqId%>";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  ...
  <form action="<%=contextPath %>/yh/core/funcs/allreport/act/YHReportPrivAct/updateReportPrivAct.act"  method="post" name="form1" onSubmit="return CheckForm();">
