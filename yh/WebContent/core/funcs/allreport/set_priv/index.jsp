...
<script type="text/javascript">
 function doInit(){
     var url = contextPath + "/yh/core/funcs/allreport/act/YHReportPrivAct/getReportPrivByRidAct.act?rId=<%=rId%>";
         ...
         if(data.length<=0){
             ...
             $("showtable").style.display="none"; 
              ...
              for(var i=0;i<data.length;i++){
                ...
                var edit="<a href='edit.jsp?seqId="+data[i].seqId+"'> 编辑 </a> "
                         +"<a href=\"javascript:del('"+data[i].seqId+"')\"> 删除 </a>";
                         //alert(data[i].seqId);
 ...
 function del(seqId){
	 ...
	 var url = contextPath + "/yh/core/funcs/allreport/act/YHReportPrivAct/delReportPrivByIdAct.act";
...
<div align="center">
<input type="button"  value="添加权限" class="BigButton" onClick="location='new.jsp?rid=<%=rId%>';" title="添加权限">&nbsp;
