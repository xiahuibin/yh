...
function doInit(){
  switch(userType){
    case 'VISIT_USER' : {$('modelName').innerHTML="访问权限";$('modelNameInfo').innerHTML="指定访问权限，有权限的人员可以访问该站点或该栏目";break;}
  	case 'EDIT_USER'  : {$('modelName').innerHTML="编辑权限";$('modelNameInfo').innerHTML="指定编辑权限，有权限的人员可以编辑该站点或该栏目";break;}
  	case 'NEW_USER' 	: {$('modelName').innerHTML="新增权限";$('modelNameInfo').innerHTML="指定新增权限，有权限的人员可以新增该站点或该栏目下的子栏目";break;}
  	case 'DEL_USER' 	: {$('modelName').innerHTML="删除权限";$('modelNameInfo').innerHTML="指定删除权限，有权限的人员可以删除该站点或该栏目";break;}
  	case 'REL_USER' 	: {$('modelName').innerHTML="发布权限";$('modelNameInfo').innerHTML="指定发布权限，有权限的人员可以发布该站点或该栏目";break;}
  }
	getUser(userType);
}
