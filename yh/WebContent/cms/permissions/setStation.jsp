...
function sendForm(){
  ...
  var url =requestURL + "/setVisitById.act?stringInfo=" + stringInfo + "&seqId=" + seqId + "&userType=" + userType + "&override=" + override;
...
function getUser(action){
	var prcsJson; 
	var url =requestURL+"/getPersonIdStr.act?seqId=<%=seqId%>" + "&userType="+action;		
