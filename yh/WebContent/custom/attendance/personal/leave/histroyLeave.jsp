...
function doOnload(){
  var requestURL = "<%=contextPath%>/yh/custom/attendance/act/YHPersonalLeaveAct/selectHistroyLeave.act";
...
<table border="0" width="100%" cellspacing="0" cellpadding="3" class="small">
  <tr>
    <td class="Big"><img src="<%=imgPath %>/views/attendance.gif" WIDTH="22" HEIGHT="20" align="absmiddle"><span class="big3">  &nbsp;请假登记历史记录</span><br>
    </td>
  </tr>
</table>
<br>
