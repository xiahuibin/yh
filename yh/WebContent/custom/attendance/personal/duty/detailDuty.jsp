...
<br>
<br></br>
<div id="overtime" align="center"></div>
<div id="nullDiv" style="display:none">
 
<table class="MessageBox" align="center" width="240">
  <tr>
    <td class="msg info">
      <div class="content" style="font-size:12pt">无值班历史记录！</div>
    </td>
  </tr>
</table>

</div>
<div align="center"><br><input type="button" value="关闭" class="BigButton" onClick="window.close();" title="关闭窗口">
&nbsp;&nbsp; </div>
</body>
</html>