...
public class YHDocWordLogic {
 ...
 public boolean isHaveDocWord(Connection conn, String dwName)throws Exception{
   PreparedStatement stmt=null;
   ResultSet rs=null;
   try{
       String sql=" select 1 from oa_officialdoc_word where DW_NAME=? ";
       stmt=conn.prepareStatement(sql);
       stmt.setString(1, dwName);
