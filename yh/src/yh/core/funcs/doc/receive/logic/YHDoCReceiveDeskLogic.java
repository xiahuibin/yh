...
public class YHDoCReceiveDeskLogic{
   ...
   * @throws Exception 
   */
  public String myDocReceiveJsonDesk(Connection conn, YHPerson user,String webroot) throws Exception{
    ...
    return list2Json(docs , webroot);
  }
  
  public String list2Json(List<YHDocReceive> docs , String webroot) throws Exception{
    ...
    for(int i=0; i<docs.size(); i++){
      sb.append(docs.get(i).toJson(webroot));
      if(i < docs.size()-1){
        sb.append(",");
      }
    }
