...
import yh.core.funcs.doc.logic.YHDocumentsTypeLogic;
...
public class YHDocumentsTypeAct {
  ...
  public String addDocumentsTypeInfo(HttpServletRequest request, HttpServletResponse response) throws Exception {
    ...
    response.sendRedirect(contexPath + YHWorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/documentsType/newRemind.jsp");
    return null;
  }
  ...
  public String updateDocumentsTypeInfo(HttpServletRequest request, HttpServletResponse response) throws Exception{
    ...
    response.sendRedirect(contexPath + YHWorkFlowConst.MODULE_CONTEXT_PATH + "/flowrun/documentsType/manage.jsp");
    return null;
  }
   ...
   * @throws Exception
   */
  public String getDocumentsTypeListSelect2(HttpServletRequest request, HttpServletResponse response) throws Exception{
    Connection dbConn = null;
    String condition = request.getParameter("condition");
    try {
      YHRequestDbConn requestDbConn = (YHRequestDbConn) request.getAttribute(YHBeanKeys.REQUEST_DB_CONN_MGR);
      dbConn = requestDbConn.getSysDbConn();
      StringBuffer sb = new StringBuffer("[");
      String sql = " SELECT SEQ_ID, DW_NAME FROM oa_officialdoc_word ";
