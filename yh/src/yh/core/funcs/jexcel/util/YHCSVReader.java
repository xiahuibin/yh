 ...
 * 
 */
public class YHCSVReader implements Closeable {
     ...
     */
    public YHCSVReader(Reader reader) {
     ...
     */
    public YHCSVReader(Reader reader, char separator) {
     ...
     */
    public YHCSVReader(Reader reader, char separator, char quotechar) {
     ...
     */
    public YHCSVReader(Reader reader, char separator, char quotechar, int line) {
     ...
     *            the line number to skip for start reading 
     */
    public YHCSVReader(Reader reader, char separator, char quotechar, char escape, int line) {
