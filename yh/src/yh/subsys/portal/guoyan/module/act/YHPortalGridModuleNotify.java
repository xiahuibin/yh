...
import yh.subsys.portal.guoyan.module.logic.YHPortalGridModuleNotifyLogic;

public class YHPortalGridModuleNotify {
  /**
   * 加载列表数据,不分页的情况
   * @param request
   * @param response
  ...
  public String loadGridData(HttpServletRequest request,
    ...
    try {
      ...
      YHPortalGridModuleNotifyLogic lal = new YHPortalGridModuleNotifyLogic();
