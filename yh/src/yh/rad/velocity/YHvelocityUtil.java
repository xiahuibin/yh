...
import yh.rad.velocity.createtable.YHTableInfo;
...
public class YHvelocityUtil{
  ...
  public static void velocity(YHTableInfo[] obj, String outpath,
      String templateName, String templateUrl){
    // 获取模板引擎
    for (YHTableInfo yhTableInfo : obj){
      velocity(yhTableInfo, outpath, templateName, templateUrl);
    }
  }
  ...
  public static void velocity(YHTableInfo obj, String outpath,
    ...
    ve.setProperty(Velocity.INPUT_ENCODING, "UTF-8");
    ve.setProperty(Velocity.OUTPUT_ENCODING, "UTF-8");
    String fileName = obj.getTableName() + ".SQL";
...
//    Writer wt = null;
    ...
    try{
      ...
      // String className = ((String[])request.get("className"))[0];
      root.put("table", obj);
      root.put("columns", obj.getColumns());
